...
- `format/CompressionStreams.scala`: codec wrapping for direct compressed files and compressed tar streams
...
4. expand archive entries and workbook sheets, pass through direct compressed inputs, probe magic bytes, normalize text fallback, and filter ignored archive entries
