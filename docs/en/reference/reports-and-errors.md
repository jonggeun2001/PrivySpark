...
- Sampled non-CSV/non-JSON groups keep file-level identifiers on the batch path because they have not been promoted through exact-split directory aggregation.
