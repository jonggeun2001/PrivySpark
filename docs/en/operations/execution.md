...
- `privyspark-<tag>-review-response-viewer.html` is a self-contained operator page for inspecting a collected `response-YYYYMMDD-HHMMSS.json` locally, including envelope metadata, validation messages, and per-finding decisions.
