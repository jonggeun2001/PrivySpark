...
- [reference/review-workflow.md](reference/review-workflow.md): legacy exact allowlist 파일 생성과 recurring 리뷰 전환
...
- [코드 맵](../dev/CODE_MAP.md): 패키지 책임과 핵심 소스 진입점
- [입력 케이스](../../samples/input-cases/README.md), [오프라인 리뷰 예시](../../samples/offline-review/README.md)
